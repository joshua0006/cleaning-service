      ...
      <div className="container-padding-x container mx-auto flex flex-col gap-10 md:gap-12 relative z-10">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-6 lg:grid-cols-4">
          <div className="flex flex-col items-center gap-5 text-center group hover:scale-105 transition-transform duration-300">
            <div
              ...
              style={{
                ...
                boxShadow: '0 10px 30px -5px rgba(92, 142, 133, 0.5), 0 0 0 3px rgba(92, 142, 133, 0.3)'
              }}
            >
              <CalendarCheck className="text-white h-7 w-7" />
            </div>
            <div className="flex flex-col gap-2">
              <h3 className="text-foreground font-semibold text-lg">1. Choose Service</h3>
          ...
          <div className="flex flex-col items-center gap-5 text-center group hover:scale-105 transition-transform duration-300">
            ...
            <div className="flex flex-col gap-2">
              <h3 className="text-foreground font-semibold text-lg">2. Pick Schedule</h3>
              <p className="text-foreground/70">
          ...
          <div className="flex flex-col items-center gap-5 text-center group hover:scale-105 transition-transform duration-300">
            ...
            <div className="flex flex-col gap-2">
              <h3 className="text-foreground font-semibold text-lg">3. Relax</h3>
              <p className="text-foreground/70">
          ...
          <div className="flex flex-col items-center gap-5 text-center group hover:scale-105 transition-transform duration-300">
            ...
            <div className="flex flex-col gap-2">
              <h3 className="text-foreground font-semibold text-lg">4. Enjoy</h3>
              <p className="text-foreground/70">
