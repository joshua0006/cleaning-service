    ...
    <div className="relative w-full max-w-3xl mx-auto h-48 md:h-64">
      ...
      <div className="absolute left-[20%] bottom-0 transform rotate-6">
        <svg width="90" height="140" viewBox="0 0 90 140" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <g transform="translate(45, 110)">
            <line x1="-15" y1="0" x2="-15" y2="25" stroke="#6BB6FF" strokeWidth="3" strokeLinecap="round"/>
            <line x1="-10" y1="0" x2="-10" y2="28" stroke="#6BB6FF" strokeWidth="3" strokeLinecap="round"/>
            <line x1="-5" y1="0" x2="-5" y2="26" stroke="#6BB6FF" strokeWidth="3" strokeLinecap="round"/>
            <line x1="0" y1="0" x2="0" y2="30" stroke="#6BB6FF" strokeWidth="3" strokeLinecap="round"/>
            <line x1="5" y1="0" x2="5" y2="27" stroke="#6BB6FF" strokeWidth="3" strokeLinecap="round"/>
            <line x1="10" y1="0" x2="10" y2="29" stroke="#6BB6FF" strokeWidth="3" strokeLinecap="round"/>
            <line x1="15" y1="0" x2="15" y2="26" stroke="#6BB6FF" strokeWidth="3" strokeLinecap="round"/>
          </g>
        </svg>
      </div>
      ...
      <div className="absolute left-1/2 -translate-x-1/2 bottom-0">
        <svg width="100" height="130" viewBox="0 0 100 130" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Duster Handle */}
          <rect x="46" y="20" width="8" height="45" rx="2" fill="#A8D5FF" stroke="#7EC4FF" strokeWidth="2"/>
          {/* Duster Head */}
          <ellipse cx="50" cy="18" rx="20" ry="12" fill="#047fff" stroke="#0368cc" strokeWidth="2"/>
          {/* Feather texture */}
          <g opacity="0.6">
            <line x1="35" y1="18" x2="30" y2="12" stroke="#0368cc" strokeWidth="1.5"/>
            <line x1="40" y1="15" x2="36" y2="8" stroke="#0368cc" strokeWidth="1.5"/>
            <line x1="50" y1="12" x2="50" y2="5" stroke="#0368cc" strokeWidth="1.5"/>
            <line x1="60" y1="15" x2="64" y2="8" stroke="#0368cc" strokeWidth="1.5"/>
            <line x1="65" y1="18" x2="70" y2="12" stroke="#0368cc" strokeWidth="1.5"/>
          </g>
        </svg>
      </div>
      ...
      <div className="absolute right-[20%] bottom-0 transform -rotate-8">
        <svg width="85" height="115" viewBox="0 0 85 115" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Sponge */}
          <rect x="30" y="35" width="26" height="35" rx="3" fill="#6BB6FF" stroke="#4A9FE5" strokeWidth="2"/>
          <rect x="30" y="35" width="26" height="15" rx="3" fill="#A8D5FF" stroke="#7EC4FF" strokeWidth="2"/>
          {/* Sponge texture */}
          <g opacity="0.4">
            <circle cx="36" cy="50" r="2" fill="#4A9FE5"/>
            <circle cx="43" cy="55" r="2" fill="#4A9FE5"/>
            <circle cx="50" cy="52" r="2" fill="#4A9FE5"/>
            <circle cx="38" cy="62" r="2" fill="#4A9FE5"/>
            <circle cx="48" cy="63" r="2" fill="#4A9FE5"/>
          </g>
        </svg>
      </div>
      ...
      <div className="absolute right-[5%] bottom-0 transform rotate-10">
        <svg width="75" height="110" viewBox="0 0 75 110" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Glove */}
          <path d="M20 40 L20 95 Q20 100 25 100 L50 100 Q55 100 55 95 L55 40" fill="#A8D5FF" stroke="#7EC4FF" strokeWidth="2"/>
          {/* Glove cuff */}
          <rect x="20" y="35" width="35" height="8" rx="2" fill="#7EC4FF" stroke="#4A9FE5" strokeWidth="1.5"/>
          {/* Fingers outline */}
          <g opacity="0.3">
            <path d="M25 40 L25 60" stroke="#4A9FE5" strokeWidth="1.5"/>
            <path d="M32 40 L32 65" stroke="#4A9FE5" strokeWidth="1.5"/>
            <path d="M39 40 L39 63" stroke="#4A9FE5" strokeWidth="1.5"/>
            <path d="M46 40 L46 60" stroke="#4A9FE5" strokeWidth="1.5"/>
          </g>
        </svg>
      </div>
      ...
      <div className="absolute left-[12%] bottom-0 transform rotate-3">
        <svg width="70" height="105" viewBox="0 0 70 105" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Bottle */}
          <path d="M25 20 L25 55 Q25 58 28 58 L42 58 Q45 58 45 55 L45 20" fill="#6BB6FF" stroke="#4A9FE5" strokeWidth="2" opacity="0.7"/>
          <ellipse cx="35" cy="20" rx="10" ry="5" fill="#6BB6FF" stroke="#4A9FE5" strokeWidth="2" opacity="0.7"/>
        </svg>
      </div>
    </div>
  )
